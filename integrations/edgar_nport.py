...
_TRUST_COMPOSITIONS: dict[str, dict] = {
    ...
    "ARKB": {"underlying": "Bitcoin", "coin_pct": 99.5, "cash_pct": 0.5,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/ARKB/"},
    ...
    "ETHW": {"underlying": "Ethereum", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/ETHW/"},
    "CETH": {"underlying": "Ethereum", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/CETH/"},
    ...
    "BTCW": {"underlying": "Bitcoin", "coin_pct": 99.5, "cash_pct": 0.5,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://www.wisdomtree.com/investments/etfs/crypto/btcw"},
    "DEFI": {"underlying": "Bitcoin", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "BitGo Trust Company",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/DEFI/"},

    # Altcoin spot trusts — same '33-Act grantor structure as BTC/ETH
    "BSOL": {"underlying": "Solana", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://bsoletf.com/"},
    "FSOL": {"underlying": "Solana", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Fidelity Digital Asset Services, LLC",
             "issuer_holdings_url": "https://institutional.fidelity.com/app/funds-and-products/etp/summary/fsol.html"},
    "SSOL": {"underlying": "Solana", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/SSOL/"},
    "QSOL": {"underlying": "Solana", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://www.invesco.com/us/financial-products/etfs"},
    "GSOL": {"underlying": "Solana", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://www.grayscale.com/funds/grayscale-solana-trust"},
    "XRPC": {"underlying": "XRP", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Anchorage Digital Bank, N.A.",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/XRPC/"},
    "XRPR": {"underlying": "XRP", "coin_pct": 98.5, "cash_pct": 1.5,
             "custodian": "Anchorage Digital Bank, N.A.",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/XRPR/",
             "structure_note": "'40-Act fund using total-return swaps on spot XRP (not direct spot holding)."},
    "XRP":  {"underlying": "XRP", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://www.grayscale.com/funds/grayscale-xrp-trust"},
    "BXRP": {"underlying": "XRP", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/BXRP/"},
    "LTCO": {"underlying": "Litecoin", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Gemini Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/LTCO/"},
    "GLTC": {"underlying": "Litecoin", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://www.grayscale.com/funds/grayscale-litecoin-trust"},
    "DOGE": {"underlying": "Dogecoin", "coin_pct": 98.5, "cash_pct": 1.5,
             "custodian": "Anchorage Digital Bank, N.A.",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/DOGE/",
             "structure_note": "'40-Act fund using total-return swaps on spot DOGE."},
    "CDOG": {"underlying": "Dogecoin", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/CDOG/"},
    "HBR":  {"underlying": "HBAR", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Gemini Trust Company, LLC",
             "issuer_holdings_url": "https://finance.yahoo.com/quote/HBR/"},
    "AVAX": {"underlying": "Avalanche", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://www.grayscale.com/funds/grayscale-avalanche-trust"},
    "ADAX": {"underlying": "Cardano", "coin_pct": 99.0, "cash_pct": 1.0,
             "custodian": "Coinbase Custody Trust Company, LLC",
             "issuer_holdings_url": "https://www.grayscale.com/funds/grayscale-cardano-trust"},
}
